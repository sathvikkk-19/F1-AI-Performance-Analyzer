...
class RaceCoordinator:
    ...
    def _calibrated_car_score(
        ...
        # Convert the normalized feature result into a pace score
        # without overpowering actual RaceGrid upgrades.
        ...
        calibrated += self._tier_baseline_modifier(
            ...
            profile.get("total_rounds", self.TOTAL_SEASON_ROUNDS)
        )
